      ...
      <form class="create-form" method="POST" enctype="multipart/form-data">
        ...
        {!!csrf_field()!!}
            <div class="form-group">
              <label>File</label>
              <input type="file" class="form-control {{$errors->first('file') ? 'is-invalid' : NULL}}" name="file" value="{{old('file')}}" accept=".csv, application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel" />
