    ...
    <form>
      <div class="row">
        ...
        <div class="col-md-3 mt-4 p-1">
          ...
          <a href="{{route('system.account_code.index')}}" class="btn btn-primary btn-sm p-2">Clear</a>
        </div>
      </div>
    </form>
  </div>
  <div class="col-md-12">
    <h4 class="pb-4">Record Data
      <span class="float-right">
        ...
        <a href="{{route('system.account_code.upload')}}" class="btn btn-sm btn-primary">Bulk Upload</a>
