    ...
    <div class="card-body">
      ...
      <form class="create-form" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control {{$errors->first('pre_processing_cost') ? 'is-invalid' : NULL}}" id="input_pre_processing_cost" name="pre_processing_cost" placeholder="Pre-Processing Cost" value="{{old('pre_processing_cost')}}">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control {{$errors->first('post_processing_cost') ? 'is-invalid' : NULL}}" id="input_post_processing_cost" name="post_processing_cost" placeholder="Post-Processing Cost" value="{{old('post_processing_cost')}}">
