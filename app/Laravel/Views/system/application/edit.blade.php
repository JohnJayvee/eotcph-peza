    ...
    <div class="card-body">
      ...
      <form class="create-form" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control {{$errors->first('description') ? 'is-invalid' : NULL}}" id="input_title" name="description" placeholder="Description" value="{{old('description',$application->description)}}">
        ...
        <div class="form-group">
          ...
          {!!Form::select("account_code", $account_codes, old('account_code',$application->account_code), ['id' => "input_account_code", 'class' => "form-control mb-2 mr-sm-2 ".($errors->first('account_code') ? 'is-invalid' : NULL)])!!}
