    ...
    <div class="card-body">
      ...
      <form class="create-form" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control {{$errors->first('name') ? 'is-invalid' : NULL}}" id="input_title" name="name" placeholder="Peza Unit Name" value="{{old('name',$department->name)}}">
